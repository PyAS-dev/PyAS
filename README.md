...
| Module | Description |
|--------|-------------|
| `core.py` | Core module which is contains the command line |
| `algebra.py` | Algebraic operations: factor, expand, solve, modular arithmetic and primes |
| `calculus.py` | Calculus toolkit: derivatives, integrals, limits, series and curve analysis |
| `functions.py` | Evaluate mathematical functions: trigonometric, logarithms, gamma functions and error function |
| `linear_algebra.py` | Work with matrix and vector operations such as determinant, inverse, rank and rref |
